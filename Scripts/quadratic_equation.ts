...
const output = document.querySelector('.programContainer__divResult');
const calculateButton = document.querySelector('.programContainer__calculateButton');
const resetButton = document.querySelector('.programContainer_resetButton');
...
function calculate(){
    const a = document.querySelectorAll('input')[0].valueAsNumber;
    const b = document.querySelectorAll('input')[1].valueAsNumber;
    const c = document.querySelectorAll('input')[2].valueAsNumber;    
